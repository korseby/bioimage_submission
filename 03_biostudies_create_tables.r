...
# Arguments
input_photo_list_filename <- args[1] # "~/Desktop/liverworts/_photos/_liverworts_photos_list.csv"
input_dir <- args[2] # "/Volumes/micromoss_05/BioStudies/Lunularia cruciata"
input_idr_dir <- args[3] # "/Volumes/micromoss_05/20220405-Globus/Lunularia cruciata"
input_processed_dir <- args[4] # "/Volumes/micromoss_03/2021/2021-12-08 Lunularia cruciata"
output_dir <- args[5] # "/Volumes/micromoss_05/BioStudies"
...
# Stitch name
img_stitch_files <- unique(gsub(x=gsub(x=list.files(input_processed_dir, pattern="IMG_*"), pattern="\\.TIF", replacement=""), pattern="\\)\\ \\(.*", replacement="\\)"))
